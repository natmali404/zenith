...
export default function GameTile({
  ...
  return (
    <div
      className={`relative bg-gradient-to-br from-purple-900 to-purple-600 ${completed ? "filter grayscale" : ""} rounded-lg p-4 w-full h-40 flex items-end justify-center hover:scale-105 transition cursor-pointer overflow-hidden`}
    >
      {/* {completed && (
    <div className="absolute inset-0 bg-violet-500 pointer-events-none rounded-lg"></div>
  )} */}
